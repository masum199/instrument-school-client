...
import logoF from '../../assets/images/academy logo.jpg'

const Footer = () => {
    return (
        <footer className="px-10 divide-y dark:bg-gray-800 dark:text-gray-100">
            ...
            <div className="lg:w-1/3">
                <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                    <div className="flex items-center justify-center w-20 h-12 rounded-full dark:bg-violet-400">
                        <img className='w-20' src={logoF} alt="" />
                    </div>
                    <span className="self-center text-2xl font-semibold">Summer Hub</span>
                </a>
            </div>
