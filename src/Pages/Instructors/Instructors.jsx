  ...
  return (
    <div className=''>
        ...
        <p class="mb-12 text-xl font-normal text-center text-gray-500 dark:text-gray-200">
            Meat the best Instructor in world
        </p>
      <div className='grid grid-cols gap-y-10 lg:grid-cols-4'>
      {instructors.map((instructor) => (
      <>
      <div class="p-4">
    <div class="mb-4 text-center opacity-90">
        <a href="#" class="relative block">
            <img alt="profil" src={instructor.photo} class="mx-auto object-cover rounded-full h-40 w-40 "/>
        </a>
    </div>
